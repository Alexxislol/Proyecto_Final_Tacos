        ...
        <table class="table" id="myTable2">
          ...
          foreach ($rst as $key){
            ...
            <tr id="insumoData'.$key['id'].'">
              ...
              <td>'.$key['catename'].'</td>
              <td>'.$key['codigo'].'</td>
              <td id="insumoPriceData'.$key['id'].'" data-price="'.$key['precio'].'">GTQ '.$key['precio'].'</td>
              <td>
        ...
        <div class="col-md-3">
            <div class="card">
              <div class="card-body text-center">
                <h3>Total:</h3>
                <h1 class="totalsumh">GTQ '.TOTALSUM.'</h1>
              </div>
            </div>    
            <p></p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <input id="paymo" type="text" class="form-control text-center" placeholder="GTQ 0">
